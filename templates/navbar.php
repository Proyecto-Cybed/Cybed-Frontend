...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
	<div class="container-fluid">
		<a class="navbar-brand fs-1 fw-bold" href="index.php">
			<img src="assets/images/logo_big.png" width="80px" alt="Cybed logo">
		CYBED
		</a>
		...
		<div class="collapse navbar-collapse d-flex justify-content-end" id="navbarSupportedContent">
			<ul class="navbar-nav">
				...
				<li class="nav-item"><a class="btn btn-lg nav-link <?= ($activePage == 'login' || $activePage == 'signup') ? 'active' : ''; ?>" href="login.php"> Iniciar Sesión / Inscribirse</a></li>
			</ul>
		</div>
	</div>
</nav>
